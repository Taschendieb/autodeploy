...
exports.appendDeployment = async function(deployment) {
    ...
    fs.readFile("lib/apimap.json", function (err, data) {
        ...
        fs.writeFile("lib/apimap.json", JSON.stringify(json), (err) => {
            if (err) {
                throw err;
            }
        })
...
exports.updateDeployments = async function(deployments) {
    exports.createConfigIfNonExistent()
    fs.readFile("lib/apimap.json", (err, data) => {
        if (err) {
            throw err;
        }
        ...
        fs.writeFile("lib/apimap.json", JSON.stringify(d), (err) => {
            if (err) {
                throw err;
            }
        })
...
exports.getDeployment = async function(name) {
    return new Promise((resolve, reject) => {
        if (!fs.existsSync("lib/apimap.json")) {
            ...
            fs.readFile("lib/apimap.json", async (err, data) => {
                if (err) {
                    throw err;
                } else {
